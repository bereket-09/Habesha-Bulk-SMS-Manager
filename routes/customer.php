...
Route::prefix('trivia')->name('trivia.')->group(function () {
    Route::get('/quick-send', 'TriviaController@TriviaQuickSend')->name('quick_send');
    Route::get('/trivia-builder', 'TriviaController@TriviaCampaignBuilder')->name('campaign_builder');
    Route::post('/quick-send', 'CampaignController@postTriviaQuickSend');
    Route::post('/campaign-builder', 'CampaignController@storeTriviaCampaign');
    Route::get('/import', 'CampaignController@TriviaImport')->name('import');
    Route::post('/import', 'CampaignController@importTriviaCampaign');
    Route::post('/import_process', 'CampaignController@TriviaImportProcess')->name('import_process');
});
...
Route::prefix('chat-box')->name('chatbox.')->group(function () {
    ...
    Route::get('/{box}/reply', 'ChatBoxController@reply')->name('reply');
