...
<div class="main-menu menu-fixed {{(($configData['theme'] === 'dark') || ($configData['theme'] === 'semi-dark')) ? 'menu-dark' : 'menu-light'}} menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="brand-logo">
        <img src="{{ asset(config('app.logo')) }}" alt="{{ config('app.name') }}" style="width:180px;margin-bottom:0px;"/>
    </div>
</a>
            ...
            @else
                <li class="nav-item me-auto">
                    <a class="navbar-brand" href="{{route('admin.home')}}">
                        <div class="brand-logo">
                            <img src="{{asset(config('app.logo'))}}" alt="{{ config('app.name') }}"  style="width:180px; height:70px;"/>
                        </div>
                    </a>
                </li>
            @endif
