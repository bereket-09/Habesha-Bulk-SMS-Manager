...
//                 //  $transport = new Socket(['10.32.9.99'], 5016);
//                  $transport->setRecvTimeout(60000);
//                  $smppClient = new SmppClient($transport);
//                  $transport->open();
//                  $smppClient->bindReceiver($server->username, $server->password);

//                 // $smppClient->bindReceiver('bekitest', 'bekitest');
        
//                  $output = $smppClient->readSMS();
        
//                  // Log successful operation
//                  error_log('SMPP operation successful for server: ' . $server->api_link);
        
//              } catch (Exception $e) {
//                  // Log the error
//                  error_log('SMPP error for server ' . $server->api_link . ': ' . $e->getMessage());
        
//                  // Set the error message as the output
//                  $output = $e->getMessage();
//              }
//                                     }
//             /* $smppClient->close();*/
