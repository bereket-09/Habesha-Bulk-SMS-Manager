...
class ChatBoxController extends Controller
{
    ...
    public function new(): View|Factory|RedirectResponse|Application
    {
        ...
        $sender_ids = PhoneNumbers::where('user_id', Auth::user()->id)->where('status', 'assigned')->cursor();
...
dd($input);
    ...
    public function reply(ChatBox $box, Campaigns $campaign, Request $request): JsonResponse
    {
        ...
        $messageValue = $request->input('message'); // Extracting message from query parameters
