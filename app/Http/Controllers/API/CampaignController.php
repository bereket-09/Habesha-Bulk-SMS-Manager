...
class CampaignController extends Controller
{
    ...
    public function smsSend(Campaigns $campaign, SendAPISMS $request, Carbon $carbon): JsonResponse
    {
        ...
        try {
            ...
            // $input['sending_server'] = $user->api_sending_server;
            $sending=$user->api_sending_server;
            $input     = $this->prepareInput($request, $user, $sms_type, $carbon,$sending);
    ...
    private function prepareInput($request, $user, $sms_type, $carbon,$sending)
    {
        $input = [
